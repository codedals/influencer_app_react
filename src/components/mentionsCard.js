...
class MentionsCard extends React.Component {
    ...
    handleClick(event){
        ...
        if(target_mention != null){
            ...
            if (posts_length > 0){
                var link = "https://instagram.com/" + keyword.substring(1);
                title_div.innerHTML="<div class='title-container'><span class='title-bar'>" + posts_length + " posts mentioning " + "<a href=" + link + ">"+ keyword + "</a>" + ":" + "</span>";
            }
