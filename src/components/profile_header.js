    	...
    	return(
          	...
          	<Row style={{height:'75px'}}>
                  <Col className="profile-app-image" span={8}>
                    <div className="profile-image" style={{backgroundImage: `url(${this.props.profile.attributes.profile_pic_url})`}}></div>
                    </Col>

                    <Col className="profile-header" span={14}>
                      <span >
      		        <div className="skew">{this.props.profile.attributes.username}</div>
              	      </span>
                    </Col>
