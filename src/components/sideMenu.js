...
const SideMenu = (props) => {
	...
	return (
	    ...
	    <div className="menu-container"
				style={props.fullLength ? {top: '40%'} : null}
			>
	      <Menu theme="dark"
					mode="vertical"
	      ...
	      >
	          ...
	          <span>
	            <FontAwesomeIcon icon={['fas', 'user-circle']} fixedWidth/><span className="menuTitle">Tagged Accounts</span>
					...
					<div style={{height: '1.2em', width: '100%', backgroundColor: 'transparent'}}>
					</div>

					<Menu.Item key='7' className="menuItem">
	          <span>
	            <FontAwesomeIcon icon={['fas', 'heart']} fixedWidth/><span className="menuTitle">Favorites</span>
	          </span>
	        </Menu.Item>
